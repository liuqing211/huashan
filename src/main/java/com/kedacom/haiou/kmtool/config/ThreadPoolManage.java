...
import com.kedacom.haiou.kmtool.service.HandleDataThread;
...
@Component
public class ThreadPoolManage implements BeanFactoryAware {
    ...
    // 线程池所使用的缓冲队列大小
    private final static int WORK_QUEUE_SIZE = 100000;
    ...
    final RejectedExecutionHandler handler = new RejectedExecutionHandler() {
        ...
        public void rejectedExecution(Runnable r, ThreadPoolExecutor executor) {
            //订单加入到缓冲队列
            msgQueue.offer(((HandleDataThread) r).getData());
            System.out.println("系统任务太忙了,把此订单交给(调度线程池)逐一处理，订单号：" + ((HandleDataThread) r).getData());
        }
    };
    ...
    public void addOrders(String orderId){
        ...
        if (cacheMap.get(orderId) == null) {
            ...
            HandleDataThread businessThread = new HandleDataThread(orderId);
